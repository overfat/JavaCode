...
public class Logger {
    ...
    @Pointcut("execution(* com.hfx.service.impl.*.*(..))")
    private void pt1(){}
    /**
     * 前置通知
     */
    ...
    // 环绕通知
//    @Around("pt1()")
    public Object aroungPrintLog(ProceedingJoinPoint pjp){
        Object rtValue = null;
        try{
            ...
            System.out.println("Logger类中的异常方法开始记录日志了。。。");
